...
--Inserindo os clientes na tabela CUSTOMERS
...
VALUES('Roberto','Silva','(11)964','roberto@gmail.com','Rua José, 32', 'São Roque','SP','1987-04-25'),
      ('MARIA','Gomes','(11)974','maria@yahoo.com','Rua Das Flores, 44', 'São Roque','SP','1988-03-24'),
      ('Renata','Antunes','(11)974','renata@hotmail.com','Rua Antunes, 55', 'Sorocaba','SP','1970-05-01'),
      ...
      ('Carolina','Medeiros','(11)935','carol@ig.com.br','Rua Jatobás, 1', 'Cajamar','SP','1974-08-21'),
      ('Marcos','Rodrigues','(11)972','marcos@uol.com.br','Rua das Amazonas, 89', 'Refice','PE','1966-05-25');